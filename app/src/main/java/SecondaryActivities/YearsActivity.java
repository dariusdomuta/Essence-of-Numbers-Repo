    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(YearsActivity.this, ResultActivity.class);
                final String inputString = inputEditText.getText().toString();
                if (inputString.equals("")) {
                    Toast.makeText(YearsActivity.this, "Cannot show results without an input", Toast.LENGTH_LONG).show();
                } else {
                    intent.putExtra(MainActivity.EXTRA_DATA_FOR_INTENT, new String[] {"year", "no", inputString});
        ...
        randomizeButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(YearsActivity.this, ResultActivity.class);
                final String inputString = inputEditText.getText().toString();
                intent.putExtra(MainActivity.EXTRA_DATA_FOR_INTENT, new String[] {"year", "yes", ""});
                startActivity(intent);
            }
        });
